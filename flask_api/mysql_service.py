# this is the mysql service used to communicate with the backend. it involves communicating with tables in the onspot database
import mysql.connector
import random
from datetime import datetime
from flask import jsonify

# connector method for the onspot db
def connect():
