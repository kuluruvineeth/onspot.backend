...
def pothole_results():
    ...
    imgcv = cv2.imread("/var/www/html/onspot/onspot_backend/backend/darkflow/sample_img/000008.png")
    ...
    for item in result:
        ...
        imgcv = cv2.putText(imgcv, item["label"], (text_x, text_y), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 255, 0), 2,
                            cv2.LINE_AA)
        cv2.imwrite("/var/www/html/onspot/onspot_backend/backend/darkflow/sample_img/a.jpg", imgcv)

    return "https://www.onspot.click/onspot/onspot_backend/backend/darkflow/sample_img/a.jpg"
